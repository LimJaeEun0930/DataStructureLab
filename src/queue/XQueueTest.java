 ...
 */
class XQueueTest {
    private XLinkedQueue<Integer> queue;
...
//        }
//        for (int i = 0; i < 4; ++i) {
//            System.out.printf("deq: %d, front: %d, rear: %d, size: %d, capa: %d" + System.lineSeparator(), queue.dequeue(), queue.getFront(), queue.getRear(), queue.getSize(), queue.getCapacity());
//        }
//        for (int i = 0; i < 5; ++i) {
//            queue.enqueue(i);
//        }
